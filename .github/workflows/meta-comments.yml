    ...
    steps:
      ...
      - name: Sync Meta data to Google Sheets
        env:
          ...
          GEMINI_API_MODE: ${{ vars.GEMINI_API_MODE || 'interactions' }}
          ...
          GEMINI_BATCH_SIZE: ${{ vars.GEMINI_BATCH_SIZE || '20' }}
          ...
          GEMINI_FALLBACK_ON_ERROR: ${{ vars.GEMINI_FALLBACK_ON_ERROR || 'true' }}
